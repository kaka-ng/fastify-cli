...
export abstract class Command extends RawCommand {
  protected async parse<F extends FlagOutput, G extends FlagOutput, A extends { [name: string]: any }>(options?: Interfaces.Input<F, G>, argv = this.argv): Promise<Interfaces.ParserOutput<F, G, A>> {
